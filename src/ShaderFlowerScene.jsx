...
export default function ShaderFlowerScene({ onComplete }) {
  ...
  useEffect(() => {
    ...
    let renderer, shaderMaterial, basicMaterial, sceneShader, sceneBasic, camera, clock, renderTargets
    let pointer = { x: 0, y: 0, clicked: false, vanishCanvas: false }
  ...
  }, [flowerCount, onComplete])

  return (
    <div className="scene scene1">
      <canvas ref={canvasRef} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} />
      <div className="touch-text" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', color: 'white', fontSize: '4vw', textAlign: 'center', pointerEvents: 'none', textShadow: '0 0 5px #000' }}>
        Touch the screen 🌸
      </div>
      {flowerCount >= 5 && (
        <div className="beautiful-text" style={{ position: 'absolute', bottom: '20%', left: '50%', transform: 'translateX(-50%)', color: '#ffb6c1', fontSize: '1.5rem', textAlign: 'center', fontStyle: 'italic' }}>
